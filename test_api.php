...
// Check API config
$config = App\Models\ApiConfig::where('network_type', $order->network_type)
...
$apiEnabled = App\Models\PaymentConfig::where('config_key', 'api_enabled')->value('config_value');
echo "api_enabled value: " . var_export($apiEnabled, true) . "\n\n";

// Test purchaseData
$svc = new App\Services\ExternalApiService($order->network_type);
