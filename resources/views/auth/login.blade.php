...
<div class="min-h-screen flex items-center justify-center bg-[#FAFAFA] font-sans p-4 sm:p-6 lg:p-8">
    ...
    <div class="w-full max-w-5xl bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row min-h-[580px]">
        ...
        <div class="w-full lg:w-[45%] flex flex-col justify-center items-center px-6 sm:px-10 lg:px-14 py-10">
            <div class="w-full max-w-sm">
                ...
                <div class="text-center mb-7">
                    ...
                    <p class="text-slate-500 text-sm mt-2">Sign in to your Xpressdatahub account</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-3.5">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="ndh_togglePass('password','eye')"
                                class="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition">
                            <span id="eye"><svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /></svg></span>
                        </button>
                    </div>

                    <div class="flex justify-end">
                        <a href="{{ route('password.request') }}" class="text-xs font-medium text-slate-500 hover:text-[#FF7A00] transition">Forgot password?</a>
                    </div>

                    <button type="submit" class="w-full py-3 bg-gradient-to-r from-[#C2410C] to-[#F97316] hover:from-[#9A3412] hover:to-[#EA580C] text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-orange-500/25">
                        Sign In
                    </button>
                </form>
                ...
                <a href="{{ route('register') }}" class="w-full flex items-center justify-center gap-2.5 py-2.5 bg-white border border-slate-200 shadow-sm rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 hover:border-slate-300 transition">
                    <x-heroicon-o-user-plus class="w-5 h-5 text-[#FF7A00]" />
                    Create an Account
                </a>

                <a href="{{ route('guest.login') }}" class="w-full flex items-center justify-center gap-2.5 py-2.5 mt-3 bg-white border border-dashed border-slate-300 rounded-xl text-xs font-bold text-slate-500 hover:bg-slate-50 hover:text-[#FF7A00] hover:border-[#FF7A00]/40 transition">
        ...
        <div class="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-gradient-to-br from-[#C2410C] via-[#EA580C] to-[#F97316]">
            <svg class="absolute inset-0 w-full h-full object-cover opacity-20" viewBox="0 0 100 100" preserveAspectRatio="none">
                <path d="M0,50 Q25,20 50,50 T100,50 L100,100 L0,100 Z" fill="#FB923C"></path>
            ...
            <div class="relative z-10 w-full h-full flex items-center justify-center p-10">
                <div class="relative w-full max-w-md rounded-[2rem] border border-white/30 p-8 flex flex-col justify-between overflow-hidden min-h-[460px]"
                    ...
                    <h2 class="text-2xl font-bold text-white leading-tight max-w-[260px]">
                        Welcome back. Sign in to manage your data bundles and grow your business.
                    </h2>
                    <div class="absolute bottom-0 right-0 w-[85%] h-[60%] rounded-tl-3xl overflow-hidden translate-x-4 translate-y-4">
                        <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=600&h=800" alt="Analytics Dashboard" class="w-full h-full object-cover object-top opacity-90 mix-blend-luminosity hover:mix-blend-normal transition duration-500">
                    </div>
